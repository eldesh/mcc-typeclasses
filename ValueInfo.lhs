% -*- LaTeX -*-
% $Id: ValueInfo.lhs 2527 2007-10-22 13:49:27Z wlux $
%
...
>         predefDC c ty =
>           predefTopEnv c' (DataConstructor c' ls stdConstrInfo (polyType ty))
>           where c' = qualify c
>                 ls = replicate (arrowArity ty) anonId
>         tupleDC ty =
>           DataConstructor tc (replicate n anonId) stdConstrInfo
