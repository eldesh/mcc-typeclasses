...
-- skolem type of x. (See lp006.curry and lp007.curry for variants of
-- this test where g2 and g3, respectively, are not commented out. Also
-- see lp008.curry for a variant using universal quantification.)
