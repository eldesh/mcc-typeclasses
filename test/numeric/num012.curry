-- Literals in fcase alternatives (as well as in equation heads) are not
...
-- which suspends when n is a free variable (cf. num011.curry and
...
even n = fcase n of { 0 -> True; 1 -> False; S (S n) -> even n }
